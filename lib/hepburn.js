...
var hiraganaTrigraphs = {
  "きゃあ": "KYĀ", "きゅう": "KYŪ", "きょう": "KYŌ",
  "しゃあ": "SHĀ", "しゅう": "SHŪ", "しょう": "SHŌ",
  "ちゃあ": "CHĀ", "ちゅう": "CHŪ", "ちょう": "CHŌ",
  "にゃあ": "NYĀ", "にゅう": "NYŪ", "にょう": "NYŌ",
  "ひゃあ": "HYĀ", "ひゅう": "HYŪ", "ひょう": "HYŌ",
  "みゃあ": "MYĀ", "みゅう": "MYŪ", "みょう": "MYŌ",
  "りゃあ": "RYĀ", "りゅう": "RYŪ", "りょう": "RYŌ",
  "ぎゃあ": "GYĀ", "ぎゅう": "GYŪ", "ぎょう": "GYŌ",
  "じゃあ": "JĀ", "じゅう": "JŪ", "じょう": "JŌ",
  "びゃあ": "BYĀ", "びゅう": "BYŪ", "びょう": "BYŌ",
  "ぴゃあ": "PYĀ", "ぴゅう": "PYŪ", "ぴょう": "PYŌ"
};
...
var katakanaDigraphs = {
  ...
  "カア": "KĀ", "キイ": "KĪ", "クウ": "KŪ", "ケエ": "KĒ", "コオ": "KŌ",
  "サア": "SĀ", "シイ": "SHĪ", "スウ": "SŪ", "セエ": "SĒ", "ソオ": "SŌ",
  "タア": "TĀ", "チイ": "CHĪ", "ツウ": "TSŪ", "テエ": "TĒ", "トオ": "TŌ",
  "ナア": "NĀ", "ニイ": "NĪ", "ヌウ": "NŪ", "ネエ": "NĒ", "ノオ": "NŌ",
  "ハア": "HĀ", "ヒイ": "HĪ", "フウ": "FŪ", "ヘエ": "HĒ", "ホオ": "HŌ",
  "マア": "MĀ", "ミイ": "MĪ", "ムウ": "MŪ", "メエ": "MĒ", "モオ": "MŌ",
  "ヤア": "YĀ", "ユウ": "YŪ", "ヨオ": "YŌ",
  "ラア": "RĀ", "リイ": "RĪ", "ルウ": "RŪ", "レエ": "RĒ", "ロオ": "RŌ",
  "ワア": "WĀ", "ヰイ": "WĪ", "ヱウ": "WĒ",  "ヲエ": "WŌ",
  "ガア": "GĀ", "ギイ": "GĪ", "グウ": "GŪ", "ゲエ": "GĒ", "ゴオ": "GŌ",
  "ザア": "ZĀ", "ジイ": "JĪ", "ズウ": "ZŪ", "ゼエ": "ZĒ", "ゾオ": "ZŌ",
  "ダア": "DĀ", "ヂイ": "DJĪ", "ヅウ": "DZŪ", "デエ": "DĒ", "ドオ": "DŌ",
  "バア": "BĀ", "ビイ": "BĪ", "ブウ": "BŪ", "ベエ": "BĒ", "ボオ": "BŌ",
  "パア": "PĀ", "ピイ": "PĪ", "プウ": "PŪ", "ペエ": "PĒ", "ポオ": "PŌ",
...
var katakanaTrigraphs = {
  ...
  "キャア": "KYĀ", "キュウ": "KYŪ", "キョウ": "KYŌ",
  "シャア": "SHĀ", "シュウ": "SHŪ", "ショウ": "SHŌ",
  "チャア": "CHĀ", "チュウ": "CHŪ", "チョウ": "CHŌ",
  "ニャア": "NYĀ", "ニュウ": "NYŪ", "ニョウ": "NYŌ",
  "ヒャア": "HYĀ", "ヒュウ": "HYŪ", "ヒョウ": "HYŌ",
  "ミャア": "MYĀ", "ミュウ": "MYŪ", "ミョウ": "MYŌ",
  "リャア": "RYĀ", "リュウ": "RYŪ", "リョウ": "RYŌ",
  "ギャア": "GYĀ", "ギュウ": "GYŪ", "ギョウ": "GYŌ",
  "ジャア": "JĀ", "ジュウ": "JŪ", "ジョウ": "JŌ",
  "ビャア": "BYĀ", "ビュウ": "BYŪ", "ビョウ": "BYŌ",
  "ピャア": "PYĀ", "ピュウ": "PYŪ", "ピョウ": "PYŌ"
};
...
Object.keys(hiraganaTrigraphs).forEach(function(key) {
  var value = hiraganaTrigraphs[key];
  if (!(value in hiraganaMap)) {
    hiraganaMap[value] = key;
  }
});
...
exports.fromKana = function(str) {
  ...
  str = bulkReplace(str, hiraganaTrigraphs);
  str = bulkReplace(str, katakanaTrigraphs);
